            ...
            <div className="footer-container">
                ...
                <div className="footer-top">
                    ...
                    <div className="footer-brand">
                        ...
                        <p className="footer-tagline">
                            Votre boutique de confiance pour des produits islamiques authentiques et de qualité.
                        </p>
                ...
                <div className="footer-bottom">
                    <p className="copyright">
                        © {new Date().getFullYear()} Islamic Shop. Tous droits réservés.
                    </p>
                    <div className="payment-methods">
                        <span className="payment-text">Paiement sécurisé</span>
